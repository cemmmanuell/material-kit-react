...
export default function EditContactGroupForm(props) {
  ...
  const formik =useFormik({
    initialValues:{
     contact_group_name:props.contact_group_details.contact_group_name,
     contact_group_id:props.contact_group_details.contact_group_id
    ...
    onSubmit: (values) => {
      ...
      axios.put(`${config.base_api}/contact_groups`,{
