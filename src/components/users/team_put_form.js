...
export default function TeamPutForm(props) {
  ...
  const formik =useFormik({
    initialValues:{
     user_group_name:props.team_details.user_group_name,
     user_group_id:props.team_details.user_group_id
    ...
    onSubmit: (values) => {
      ...
      axios.put(`${config.base_api}/user_groups`,{
